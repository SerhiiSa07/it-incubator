...
<main>
  ...
  <form action="https://www.freecatphotoapp.com/submit-cat-photo">
    <label for="personality"><input id="indoor" type="radio" name="personality"> Indoor</label>
    <label for="personality"><input id="outdoor" type="radio" name="personality"> Outdoor</label>
    <label for="personality"><input id="outdoor" type="radio" name="personality"> Outdoor</label>
    <br>
    <input type="text" placeholder="cat photo URL" required>
    <button type="submit">Submit</button>
...
value="indoor" type="radio" name="indoor-outdoor"> Indoor</label>
...
value="lazy" type="checkbox" name="personality"> Lazy</label>
    <label for="energetic"><input id="energetic" value="energetic"
